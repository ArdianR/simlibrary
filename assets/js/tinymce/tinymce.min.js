...
//generate editor simple tinymce with selector jquery
var editorsimbol = function(select, options){
	var init = $.extend(true,{
		selector: select,
		theme: "modern",
		relative_urls : false,
		plugins: [
			"advlist image lists charmap",
			"visualblocks visualchars media",
			"table contextmenu template textcolortextcolor",
			"tiny_mce_wiris"
		],
		add_unload_trigger: false,
		autosave_ask_before_unload: false,
		image_advtab: true, 
		toolbar1: "bold italic underline strikethrough  | bullist numlist | image | forecolor backcolor | table | subscript superscript | charmap | insertfile insertimage | fontselect fontsizeselect | tiny_mce_wiris_formulaEditor",
		menubar: false,
