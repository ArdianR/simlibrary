...
<tr><td class="td-label">Kategori</td><td><?php echo UI::createSelect('id_kategori',$kategoriarr,$row['id_kategori'],$edited,'form-control',"style='width:auto'")?></td></tr>
...
<tr><td class="td-label">Deskripsi</td><td><?php echo UI::createTextArea('deskripsi',$row['deskripsi'],'10','',$edited,'form-control contents')?></td></tr>
