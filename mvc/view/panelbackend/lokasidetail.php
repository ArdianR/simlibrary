...
<tr>
<td class="td-label">Kode Lokasi</td>
<td class="td-input"><?php echo UI::createTextBox('kode_lokasi',$row['kode_lokasi'],'10','10',$edited,$class='form-control ',"style='width:100px'")?></td>
</tr>
